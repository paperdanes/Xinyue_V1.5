...
def prepare_generation_config():
    with st.sidebar:
        ...
        st.image('assets/aiwei_logo.jpg', width=1, caption='XinyueLLM--灏语科技', use_column_width=True)
...
def combine_history(prompt):
    ...
    meta_instruction = (
        "你是一个拥有丰富心理学知识的温柔大姐姐，你的名字叫心悦，我有一些心理问题，请你用专业的知识和温柔、可爱的口吻帮我解决，回复中可以穿插一些可爱的Emoji表情符号或者文本符号。\n"
    )
...
def main():
    ...
    st.title("XinyueLLM（灏语科技）AI心理咨询")
